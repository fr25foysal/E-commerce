...
if ( ! function_exists( 'cartzillagb_blog_post_block_output' ) ) {
    ...
    function cartzillagb_blog_post_block_output() {
        ...
        if( isset( $_POST['attributes'] ) ) {
            ...
            $posts = get_posts( apply_filters( 'cartzillagb_render_blog_post_args', $args ) );
            ...
            if( $posts ) {
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <?php if ( $attributes['displayPostContent'] == 'true' ): 
                                        ...
                                        ?>
                                        <p class="font-size-sm"><?php echo esc_html( wp_strip_all_tags( $excerpt ) ); ?></p>
                                    <?php endif;
                ...
                $output = '<p class="text-danger text-center font-size-2">' . esc_html__( 'No posts available.', CZGB_I18N ) . '</p>';
            }
        }
                            ...
                            <div class="media media-ie-fix align-items-center pb-3">
                                ...
                                <div class="media-body pl-3">
                                    <h3 class="font-size-lg mb-0">
                                        ...
                                        <?php  printf( '%s %s', apply_filters( 'cartzillagb_seller_block_output_seller_memeber_since_text', esc_html__( 'Member Since', CZGB_I18N ) ), date( "F Y", strtotime( $user_data->user_registered ) ) ); ?>
                                    </span>
                                    <a class="btn btn-primary btn-sm" href="<?php echo esc_url( dokan_get_store_url( $user_id ) ); ?>">
                                        <?php echo apply_filters( 'cartzillagb_seller_block_output_seller_button_text', esc_html__( 'View products', CZGB_I18N ) ); ?>
                                    </a>
                                </div>
                            </div>
                        </div>
